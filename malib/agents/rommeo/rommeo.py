...
class ROMMEOAgent(OffPolicyAgent):
        ...
        if not self._custom_b:
            if self._uniform:
                opponent_policy_loss = (
                    opponent_actions_log_pis - q_values + annealing * actions_log_pis
                )
            else:
                opponent_policy_loss = (
            ...
            opponent_policy_loss = (
                self._bj * (opponent_actions_log_pis - prior_log_pis)
                - q_values
                + self._bi * actions_log_pis
            )
    ...
    def critic_loss(
        ...
        if not self._custom_b:
            ...
            q_value_targets = (
                q_value_targets
                + self._bj * (next_prior_log_pis - next_opponent_actions_log_pis)
