...
def IGA_TR(
    pi_alpha, pi_beta, payoff_0, payoff_1, u_alpha, u_beta, iteration=200, lr=0.1
):
    ...
    for i in range(iteration):
        ...
        pi_alpha_adv_gradient = (pi_beta_new - pi_beta) * u_alpha * (1.0 + lr)
        pi_beta_adv_gradient = (pi_alpha_new - pi_alpha) * u_beta * (1.0 + lr)
